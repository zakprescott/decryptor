...
const getObject = async (Bucket, Key) => {
	...
	try {
		...
		console.log(`Error getting S3 object ${Bucket}/${Key}: ${error}`);
	}
};
...
const headObject = async (Bucket, Key) => {
	...
	try {
		...
		console.log(`Error calling headObject on ${Bucket}/${Key}: ${error}`);
	}
};
...
const putObject = async (Body, Bucket, Key) => {
	...
	try {
		...
		console.log(`Error putting S3 object ${Bucket}/${Key}: ${error}`);
	}
};
